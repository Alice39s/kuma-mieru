...
const maintenanceColumns = `
  ...
  updated_at, request_hash, details_json, source_template_id, source_template_version,
...
export const createMaintenance = (
  ...
  return database.transaction(() => {
    ...
    const template = resolveEventTemplateApplication(database, input.template, 'maintenance');
    const id = randomUUID();
      ...
      .prepare(
        `INSERT INTO native_events
          (id, type, page_id, title, state, version, created_by, idempotency_key,
           request_hash, created_at, updated_at, details_json, source_template_id,
           source_template_version, source_template_notify_suggestion)
